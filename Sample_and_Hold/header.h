...
unsigned char** samplehold_col(double**ori, int oripixel, int newpixel); //가로 samplehold 보간
unsigned char** samplehold_row(double **ori, int oripixel, int newpixel); //세로 samplehold 보간
